//
//  CollectionViewModel+CollectionViewDelegate.m
//  ViewModel
//
...
@implementation CollectionViewModel (CollectionViewDelegate)

#if TARGET_OS_IPHONE
- (void)collectionView:(VMCollectionView *)collectionView willDisplayCell:(VMCollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
#elif TARGET_OS_MAC
...
#if TARGET_OS_IPHONE
#elif TARGET_OS_MAC
    VMCollectionViewCell *cell = item;
#endif // #if TARGET_OS_IPHONE
...
#if TARGET_OS_IPHONE
- (void)collectionView:(VMCollectionView *)collectionView didEndDisplayingCell:(VMCollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
#elif TARGET_OS_MAC
- (void)collectionView:(NSCollectionView *)collectionView didEndDisplayingItem:(VMCollectionViewCell *)item forRepresentedObjectAtIndexPath:(NSIndexPath *)indexPath
#endif // #if TARGET_OS_IPHONE
{
#if TARGET_OS_IPHONE
#elif TARGET_OS_MAC
...
#if TARGET_OS_IPHONE
- (void)collectionView:(VMCollectionView *)collectionView willDisplaySupplementaryView:(UICollectionReusableView *)view forElementKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
#elif TARGET_OS_MAC
...
#if TARGET_OS_IPHONE
- (void)collectionView:(VMCollectionView *)collectionView didEndDisplayingSupplementaryView:(UICollectionReusableView *)view forElementOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
#elif TARGET_OS_MAC
...
#if TARGET_OS_IPHONE
- (void)collectionView:(VMCollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
#elif TARGET_OS_MAC
- (void)collectionView:(VMCollectionView *)collectionView didSelectItemsAtIndexPaths:(NSSet<NSIndexPath *> *)indexPaths
#endif // #if TARGET_OS_IPHONE
{
#if TARGET_OS_IPHONE
#elif TARGET_OS_MAC
